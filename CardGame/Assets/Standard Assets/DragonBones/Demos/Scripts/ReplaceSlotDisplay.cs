            ...
            case 1:
                {
                    ...
                    */
                    _leftWeaponIndex++;
                    _leftWeaponIndex %= WEAPON_RIGHT_LIST.Length;
                    var weaponDisplayName = WEAPON_RIGHT_LIST[_leftWeaponIndex];
                    //
                    UnityFactory.factory.ReplaceSlotDisplay("weapon_1004_show", "weapon", "weapon_r", weaponDisplayName, _leftWeaponSlot);
                }
                break;
            case -1:
                {
