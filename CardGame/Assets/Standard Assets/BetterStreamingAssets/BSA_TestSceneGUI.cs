...
namespace Better.StreamingAssets
{
    public class BSA_TestSceneGUI : MonoBehaviour
    {
        ...
        private ReadMode m_readModes = ReadMode.UnityWebRequest;
        ...
        public List<TestInfo> m_results = new List<TestInfo>();
                ...
                else if (readMode == ReadMode.BSA)
                {
                    ...
                    switch (testType)
                    {
                        ...
                        case TestType.LoadBytes:
                            ...
                            break;
                        case TestType.ReadTexts:
                            Debug.LogWarning("path:" + path);
                            Debug.LogWarning("text:" + BetterStreamingAssets.ReadAllText(path));
                            break;
                    }
                ...
                else if (readMode == ReadMode.Direct)
                {
                    ...
                    switch (testType)
                    {
                        ...
                        case TestType.ReadTexts:
                            ...
                            Debug.LogWarning("text:" + File.ReadAllText(p));
                            break;
                    }
...
#pragma warning restore 0618 // Type or member is obsolete
                    ...
                    switch (testType)
                    {
                        ...
                        case TestType.LoadBytes:
                            ...
                            break;
                        case TestType.ReadTexts:
                            Debug.LogWarning("streamingAssetsUrl:" + streamingAssetsUrl);
                            Debug.LogWarning("text:"+ www.downloadHandler.text);
                            break;
                        default:
                            throw new NotSupportedException();
                    }
